...
function showFirstAndLast(str) {
    firstAndLAst = [];
    str.forEach(el => {
        firstAndLAst.push(el.charAt(0) + el.charAt(el.length - 1));
    });
...
const myReduceFunc = (acc, cur) => acc + cur;

function joinAll(arr) {

    return arr.reduce(myReduceFunc)
}
console.log(joinAll(['hi', 'myname', 'is', 'slim', 'shady']))
...
const myReduceFunc2 = (acc, cur) => acc + cur;
...
const myWishListReducer=(acc,val) =>  acc + val.price; 
shoppingSpree = (arr) =>{
...
// const flattenArrReducer = (acc,val) => acc.concat(val)


// flatten = (arr) => {

// return arr.reduce(flattenArrReducer);
// }
// console.log(flatten([
//     ["1", "2", "3"],
//     [true],
...
console.log(numsToString([2, 5, 100])); 
// output: ['2', '5', '100']
...
takeNames = (arr) => {
   ...
   const nameArr = arr.map(x =>{
  return x.name
});
return nameArr;
}
console.log(takeNames(arr));
...
console.log(EvenNumber([3, 6, 8, 2])); 
// output: [6, 8, 2]
// Given an array of strings, return a new array that only includes those that are 5 characters or fewer in length
fiveCharactersOrFewerOnly = (num) => {
    return num.filter(el => el.length<=5)
}
...
whoIsAnIlluminati = (arr2) => {
    
    return arr2.filter(el => el.member===true)
}

console.log(whoIsAnIlluminati(arr2))
...
canSeeMAtrix = (arr3) => {
    return arr3.filter(el => el.age >=18)
}
console.log(canSeeMAtrix(arr3));
/////////////////////////////////////////
/////////////////SORT////////////////////
// sort(function(a, b) {
//     return a - b;
